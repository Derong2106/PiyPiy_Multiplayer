...
void APiyPiyHUD::AddCharacterOverlay()
{
	//APlayerController* PlayerController = GetOwningPlayerController();

	//if (CharacterOverlayClass && PlayerController && !CharacterOverlay)
	//{
	//	CharacterOverlay = CreateWidget<UCharacterOverlay>(PlayerController, CharacterOverlayClass);
...
void APiyPiyHUD::AddAnnouncement()
{
	APlayerController* PlayerController = GetOwningPlayerController();
...
void APiyPiyHUD::DrawCrosshair(UTexture2D* Texture, FVector2D ViewportCenter, FVector2D Spread, FLinearColor CrosshairColor)
{
