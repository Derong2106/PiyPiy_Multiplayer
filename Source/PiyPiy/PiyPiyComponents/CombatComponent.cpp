...
#include "PiyPiy/Weapon/Projectile.h"
#include "Components/BoxComponent.h"
#include "PiyPiy/Weapon/Shotgun.h"
...
void UCombatComponent::FireShotgun()
{
	...
	if (Shotgun)
	{
		...
		if (Character && !Character->HasAuthority()) ShotgunLocalFire(HitTargets);
...
void UCombatComponent::SetHUDCrosshairs(float DeltaTime)
{
	...
	if (Controller)
	{
		HUD = HUD == nullptr ? Cast<APiyPiyHUD>(Controller->GetHUD()) : HUD;
		if (HUD)
		{
			if (EquippedWeapon)
			{
				...
				HUDPackage.CrosshairsBottom = EquippedWeapon->CrosshairsButtom;
			}
			else
			{
